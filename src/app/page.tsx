...
import { Point } from "@/lib/types"; // Corrected import
import { useCanvasDrawing } from "@/hooks/useCanvasDrawing"; // Corrected import
import { CanvasPlotter } from "@/components/CanvasPlotter"; // Corrected import
...
export default function HomePage() {
  ...
  return (
    <div className="flex justify-center items-start min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 p-2 sm:p-4 md:p-6 lg:p-8">
      <Card className="w-full max-w-7xl shadow-xl transition-all duration-300 ease-in-out">
        ...
        <CardContent className="flex flex-col lg:flex-row gap-4 sm:gap-6 px-3 pb-3 pt-0 sm:px-4 sm:pb-4 sm:pt-0 md:px-6 md:pb-6 md:pt-0">
          ...
          <div className={`flex flex-col gap-4 ${isSidebarOpen ? 'lg:w-3/5 xl:w-[calc(66.66%-0.75rem)]' : 'lg:w-full'} transition-all duration-300 ease-in-out`}>
            <CanvasPlotter
              canvasRef={canvasRef}
            ...
            />
            {/* Buttons moved below CanvasPlotter */}
          ...
          {isSidebarOpen && (
            <div className={`flex-col gap-4 lg:w-2/5 xl:w-[calc(33.33%-0.75rem)] lg:pl-4 lg:border-l lg:border-gray-200 dark:lg:border-gray-700 ${isSidebarOpen ? 'flex' : 'hidden lg:hidden' } transition-all duration-300 ease-in-out`}>
              <ScrollArea className="h-full max-h-[calc(100vh-12rem)] lg:max-h-[calc(100vh-10rem)] pr-2">
                {/* Interpolation Settings (Moved to top) */}
                ...
                {/* Coordinate Settings (Moved below Interpolation Settings) */}
                <div className="flex flex-col gap-3">
                  <h3 className="flex items-center text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                    <Settings className="mr-2 h-5 w-5 text-primary" />
