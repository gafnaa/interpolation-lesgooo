...
export default function HomePage() {
  ...
  return (
    <div className="flex justify-center items-start min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 p-2 sm:p-4 md:p-6 lg:p-8">
      <Card className="w-full max-w-7xl shadow-xl bg-white dark:bg-gray-800">
        ...
        <CardContent className="flex flex-col gap-4 sm:gap-6 px-3 pb-3 pt-0 sm:px-4 sm:pb-4 sm:pt-0 md:px-6 md:pb-6 md:pt-0">
          {/* Canvas Section */}
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full items-center justify-between">
            <Button
              ...
              variant="outline"
              className="flex-1 text-sm sm:text-base py-2.5 border-blue-500 text-blue-600 hover:bg-blue-50 dark:border-blue-700 dark:text-blue-400 dark:hover:bg-blue-900/20"
            >
          ...
          {/* New Section for Coordinate Settings, Interpolation Settings, and Points List */}
            ...
            <div className="flex flex-col gap-3 p-4 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm bg-white dark:bg-gray-800">
              ...
              <div className="flex-grow border border-gray-200 dark:border-gray-700 rounded-md p-1 bg-white dark:bg-gray-800/50 shadow-sm">
                {points.length === 0 ? (
                  ...
                  <ScrollArea className="h-[calc(100vh-40rem)] max-h-52"> {/* Added max-h for responsiveness */}
                    <ul className="divide-y divide-gray-200 dark:divide-gray-600">
                      {points.map((p, index) => (
                        <li
                          key={index}
                          className="flex justify-between items-center py-2 px-2 sm:px-3 hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-colors duration-150"
                        >
